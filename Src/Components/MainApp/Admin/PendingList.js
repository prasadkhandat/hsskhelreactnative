...
class PendingList extends Component { 
    ...
    componentDidMount() {
        ...
        this.khelRef.orderByChild("isVerified").equalTo(0).on('value', function (snapshot) {
    ...
    alertItemName = (item) => {
        console.log('in approve buton details')
        this.props.navigation.navigate('ApproveKhel',{khelObj:JSON.stringify(item)});
    }
